...
class StepsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create step" do
    assert_difference("Step.count") do
      post steps_url, params: { step: { description: @step.description, recipe_id: @step.recipe_id } }
    end
  ...
  test "should update step" do
    patch step_url(@step), params: { step: { description: @step.description, recipe_id: @step.recipe_id } }
